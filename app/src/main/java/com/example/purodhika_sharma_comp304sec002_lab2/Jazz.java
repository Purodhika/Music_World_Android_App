...
public class Jazz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genreArrayList.add(new Listings("Title: So What", "\nArtist:Miles Davis", "\nPrice: $4"));
        genreArrayList.add(new Listings("Title: Summer Timeb", "\nArtist:Louis", "\nPrice: $2"));
        genreArrayList.add(new Listings("Title: Fever", "\nArtist:Peggy", "\nPrice: $2"));
        ...
        listingsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Jazz.this, "Welcome to Jazz Music", Toast.LENGTH_SHORT).show();

                switch (position){
                    case 0:
                        Intent intent = new Intent(Jazz.this,Jazz.class);
