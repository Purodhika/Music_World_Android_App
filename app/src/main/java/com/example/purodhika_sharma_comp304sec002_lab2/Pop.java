...
public class Pop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genreArrayList.add(new Listings("Title: Blinding Lights", "\nArtist:The Weeknd", "\nPrice: $4"));
        genreArrayList.add(new Listings("Title: Party In The U.S.A", "\nArtist:Miley Cyrus", "\nPrice: $2"));
        genreArrayList.add(new Listings("Title: Adore You", "\nArtist:Harry Styles", "\nPrice: $3"));
        ...
        listingsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Pop.this, "Welcome to Pop Music", Toast.LENGTH_SHORT).show();
