...
public class Indie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genreArrayList.add(new Listings("Title: Sage", "\nArtist:Ritviz", "\nPrice: $4"));
        genreArrayList.add(new Listings("Title:  Cold/ Mess", "\nArtist:Prateek Kuhad", "\nPrice: $2"));
        genreArrayList.add(new Listings("Title: Toxic", "\nArtist:AP Dhillon", "\nPrice: $2"));
        ...
        listingsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Indie.this, "Welcome to Indie Music", Toast.LENGTH_SHORT).show();

                switch (position){
                    case 0:
                        Intent intent = new Intent(Indie.this,Indie.class);
